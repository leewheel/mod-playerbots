...
// Up to 4 blessings per spec per tier, BLESSING_NONE-terminated.
...
inline constexpr BlessingPriorityEntry BLESSING_PRIORITIES[SPEC_PROFILE_COUNT][4] =
{
    // SPEC_PROT_WARRIOR_TANK_DK
    {
        ...
        {{ BLESSING_SANCTUARY_GREATER, BLESSING_MIGHT_GREATER,  BLESSING_KINGS_GREATER,  BLESSING_NONE           }},
        {{ BLESSING_SANCTUARY_GREATER, BLESSING_MIGHT_GREATER,  BLESSING_KINGS_GREATER,  BLESSING_NONE           }},
    },
    // SPEC_DPS_WARRIOR_DPS_DK
    {
        {{ BLESSING_MIGHT_SINGLE,      BLESSING_NONE,           BLESSING_NONE,           BLESSING_NONE           }},
        {{ BLESSING_KINGS_SINGLE,      BLESSING_MIGHT_GREATER,  BLESSING_NONE,           BLESSING_NONE           }},
        {{ BLESSING_SANCTUARY_GREATER, BLESSING_MIGHT_GREATER,  BLESSING_KINGS_GREATER,  BLESSING_NONE           }},
        {{ BLESSING_SANCTUARY_GREATER, BLESSING_MIGHT_GREATER,  BLESSING_KINGS_GREATER,  BLESSING_NONE           }},
    },
    // SPEC_CASTER_SHAMAN
    {
        ...
        {{ BLESSING_WISDOM_SINGLE,     BLESSING_KINGS_GREATER,  BLESSING_NONE,           BLESSING_NONE           }},
        {{ BLESSING_SANCTUARY_SINGLE,  BLESSING_KINGS_GREATER,  BLESSING_WISDOM_GREATER, BLESSING_NONE           }},
        {{ BLESSING_SANCTUARY_GREATER, BLESSING_MIGHT_GREATER,  BLESSING_KINGS_GREATER,  BLESSING_WISDOM_GREATER }},
    },
    // SPEC_ENHANCE_SHAMAN
    {
        {{ BLESSING_MIGHT_SINGLE,      BLESSING_NONE,           BLESSING_NONE,           BLESSING_NONE           }},
    ...
    // SPEC_HOLY_PALADIN
    {
        ...
        {{ BLESSING_KINGS_SINGLE,      BLESSING_SANCTUARY_SINGLE, BLESSING_WISDOM_GREATER, BLESSING_NONE         }},
        {{ BLESSING_SANCTUARY_GREATER, BLESSING_KINGS_GREATER,  BLESSING_MIGHT_GREATER,  BLESSING_WISDOM_GREATER }},
    },
    // SPEC_PROT_PALADIN
    {
        {{ BLESSING_SANCTUARY_SINGLE,  BLESSING_NONE,           BLESSING_NONE,           BLESSING_NONE           }},
    ...
    // SPEC_BEAR_DRUID
    {
        {{ BLESSING_SANCTUARY_SINGLE,  BLESSING_NONE,           BLESSING_NONE,           BLESSING_NONE           }},
        {{ BLESSING_SANCTUARY_SINGLE,  BLESSING_MIGHT_SINGLE,   BLESSING_NONE,           BLESSING_NONE           }},
        {{ BLESSING_SANCTUARY_SINGLE,  BLESSING_MIGHT_GREATER,  BLESSING_KINGS_GREATER,  BLESSING_NONE           }},
        {{ BLESSING_SANCTUARY_GREATER, BLESSING_MIGHT_GREATER,  BLESSING_KINGS_GREATER,  BLESSING_WISDOM_GREATER }},
    },
    // SPEC_CAT_DRUID
    {
        {{ BLESSING_MIGHT_SINGLE,      BLESSING_NONE,           BLESSING_NONE,           BLESSING_NONE           }},
        {{ BLESSING_MIGHT_SINGLE,      BLESSING_KINGS_SINGLE,   BLESSING_NONE,           BLESSING_NONE           }},
        {{ BLESSING_MIGHT_SINGLE,      BLESSING_KINGS_GREATER,  BLESSING_WISDOM_SINGLE,  BLESSING_NONE           }},
        {{ BLESSING_SANCTUARY_GREATER, BLESSING_MIGHT_GREATER,  BLESSING_KINGS_GREATER,  BLESSING_WISDOM_GREATER }},
    },
    // SPEC_CASTER_DRUID
    {
        {{ BLESSING_KINGS_SINGLE,      BLESSING_NONE,           BLESSING_NONE,           BLESSING_NONE           }},
        {{ BLESSING_KINGS_SINGLE,      BLESSING_WISDOM_SINGLE,  BLESSING_NONE,           BLESSING_NONE           }},
        {{ BLESSING_KINGS_GREATER,     BLESSING_SANCTUARY_SINGLE, BLESSING_WISDOM_SINGLE, BLESSING_NONE          }},
        {{ BLESSING_SANCTUARY_GREATER, BLESSING_KINGS_GREATER,  BLESSING_MIGHT_GREATER,  BLESSING_WISDOM_GREATER }},
    },
    // SPEC_ROGUE
    {
...
{
    if (!player)
        return SPEC_CASTER_CLOTH; // safe fallback
