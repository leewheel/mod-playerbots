...
public:
    WarriorAiObjectContextInternal()
    {
        ...
        creators["vigilance on party"] = &WarriorAiObjectContextInternal::vigilance_on_party;
...
private:
    ...
    static Action* vigilance_on_party(PlayerbotAI* botAI) { return new CastVigilanceOnPartyAction(botAI); }
