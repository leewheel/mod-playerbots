...
public:
    RageWinterchillMeleeControlAvoidanceMultiplier(PlayerbotAI* botAI)
        : Multiplier(botAI, "rage winterchill melee control avoidance multiplier") {}
    float GetValue(Action* action) override;
};
...
public:
    KazrogalControlMovementMultiplier(PlayerbotAI* botAI)
        : Multiplier(botAI, "kaz'rogal control movement multiplier") {}
    float GetValue(Action* action) override;
};
...
public:
    AzgalorMeleeDpsControlAvoidanceMultiplier(PlayerbotAI* botAI)
        : Multiplier(botAI, "azgalor melee dps control avoidance multiplier") {}
    float GetValue(Action* action) override;
};
