...
bool SartharionAttackPriorityAction::Execute(Event /*event*/)
{
    ...
    Unit* shadron = AI_VALUE2(Unit*, "find target", "30451");
    Unit* tenebron = AI_VALUE2(Unit*, "find target", "30452");
    Unit* vesperon = AI_VALUE2(Unit*, "find target", "30449");
    Unit* acolyte = AI_VALUE2(Unit*, "find target", "30688");
