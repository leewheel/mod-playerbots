...
bool FathomLordKarathressTanksPositionTargetsAction::Execute(Event /*event*/)
{
    ...
    {
        target = AI_VALUE2(Unit*, "find target", "21966");
...
bool FathomLordKarathressMisdirectBossesToTanksAction::Execute(Event /*event*/)
{
    ...
    if (hunterIndex == 0)
    {
        enemy = AI_VALUE2(Unit*, "find target", "21964");
        tank = GetGroupAssistTank(bot, 0);
    }
    else if (hunterIndex == 1)
    {
        enemy = AI_VALUE2(Unit*, "find target", "21965");
        tank = GetGroupAssistTank(bot, 2);
    }
    else if (hunterIndex == 2)
    {
        enemy = AI_VALUE2(Unit*, "find target", "21966");
...
bool FathomLordKarathressAssignDpsPriorityAction::Execute(Event /*event*/)
{
    ...
    Unit* caribdis = PlayerbotAI::IsRanged(bot) ?
        AI_VALUE2(Unit*, "find target", "21964") : nullptr;

    if (totem)
    {
        target = totem;
    }
    else if (Unit* tidalvess = AI_VALUE2(Unit*, "find target", "21965"))
    {
        target = tidalvess;
    }
    else if (caribdis)
    ...
    else if (Unit* sharkkis = AI_VALUE2(Unit*, "find target", "21966"))
    {
        target = sharkkis;
    }
