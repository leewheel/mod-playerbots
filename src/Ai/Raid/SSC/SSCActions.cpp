...
bool SerpentShrineCavernResetEncounterStatesAction::Execute(Event /*event*/)
{
    ...
    // 合并brighton 2026-08-26: 统一reset累积(移除find target守卫分支), 机械追踪器额外清DPS等待计时
...
// 合并brighton 2026-08-26: 保留我方entry规则(fathom-guard caribdis -> 21964), 使用botAI->IsRangedDps
    //By leewheel 2026年8月26日
    Unit* caribdis = AI_VALUE2(Unit*, "find target", "21964");
...
// 合并brighton 2026-08-26: 保留我方entry规则(fathom sporebat -> 22120), 使用botAI->IsMelee
    //By leewheel 2026年8月26日
...
// 合并brighton 2026-08-26: 保留我方entry规则(fathom lurker -> 21863), 使用botAI->IsMelee
    //By leewheel 2026年8月26日
