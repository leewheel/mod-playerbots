...
bool ThorimMarkDpsTargetAction::Execute(Event /*event*/)
{
    ...
    if (botAI->IsMainTank(bot))
    {
        ...
        Unit* evoker = AI_VALUE2(Unit*, "find target", "32878");
    ...
    else if (botAI->IsAssistTankOfIndex(bot, 0))
    {
        ...
        Unit* acolyte = AI_VALUE2(Unit*, "find target", "32886");
        Unit* runicColossus = AI_VALUE2(Unit*, "find target", "32872");
        Unit* ancientRuneGiant = AI_VALUE2(Unit*, "find target", "32873");
        Unit* ironHonorGuard = AI_VALUE2(Unit*, "find target", "32874");
        Unit* ironRingGuard = AI_VALUE2(Unit*, "find target", "32875");
