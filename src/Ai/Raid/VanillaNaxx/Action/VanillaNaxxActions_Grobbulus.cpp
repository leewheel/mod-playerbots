...
bool VanillaGrobbulusGoBehindAction::Execute(Event /*event*/)
{
...
bool VanillaGrobbulusMoveAwayAction::Execute(Event /*event*/)
{
    Unit* boss = AI_VALUE(Unit*, "boss target");
    if (!boss)
        return false;
...
uint32 VanillaGrobbulusRotateAction::GetCurrWaypoint()
{
